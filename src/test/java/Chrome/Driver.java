        ...
        if(aDriver==null){
            ...
            switch (useThisDriver) {
                ...
                case IE:
                    ...
                    setDriverPropertyIfNecessary("webdriver.ie.driver", "C:\\Drivers\\IEDriverServer_x64_2.41.0\\IEDriverServer.exe", "C:\\Drivers\\IEDriverServer_x64_2.41.0\\IEDriverServer.exe");
                ...
                case GOOGLECHROME:
                    ...
                    setDriverPropertyIfNecessary("webdriver.chrome.driver","C:\\Drivers\\chromedriver_win32\\chromedriver.exe","C:\\Drivers\\chromedriver_win32\\chromedriver.exe");
