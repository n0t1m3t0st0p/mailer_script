        ...
        if(aDriver==null){
            ...
            switch (useThisDriver) {
                ...
                case IE:
                    ...
                    setDriverPropertyIfNecessary("webdriver.ie.driver", "/../tools/iedriver_64/IEDriverServer.exe", "D:\\Install\\SELENIUM\\IEDriverServer_x64_2.41.0\\IEDriverServer.exe");
                ...
                case GOOGLECHROME:
                    ...
                    setDriverPropertyIfNecessary("webdriver.chrome.driver","D:\\Install\\SELENIUM\\chromedriver_win32\\chromedriver.exe","D:\\Install\\SELENIUM\\chromedriver_win32\\chromedriver.exe");
